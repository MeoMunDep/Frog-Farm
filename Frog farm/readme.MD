...
> > > Help me with your referral [Link](https://t.me/frogfarmbot/frogfarm?startapp=6713068747)
...
```json
{
  "isDoTasks": false,
  "isPlayingGames": true,
  "ref": "6713068747", //your referral link, i dont if it can work or something
  "todayCode": "IDONTKNOW",
...
> To run the bot, use the following command: `cd "frog farm-main/frog farm"; node meomundep`
